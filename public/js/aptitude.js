...
b2.addEventListener("click",()=>{
    demo2.style.display="block"
    demo2.innerHTML=`
    <h1>INFOSYS  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b3.addEventListener("click",()=>{
    demo2.style.display="block"
    demo2.innerHTML=`
    <h1>WIPRO  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b4.addEventListener("click",()=>{
    demo2.style.display="block"
    demo2.innerHTML=`
    <h1>TECH MAHINDRA  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b5.addEventListener("click",()=>{
    demo2.style.display="block"
    demo2.innerHTML=`
    <h1>COGNIZANT APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b6.addEventListener("click",()=>{
    demo2.style.display="block"
    demo2.innerHTML=`
    <h1>ACCENTURE  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b7.addEventListener("click",()=>{
    demo2.style.display="block"
    demo2.innerHTML=`
    <h1>PERSISTENT  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b8.addEventListener("click",()=>{
    demo2.style.display="block"
    demo2.innerHTML=`
    <h1>HEXWARE  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b11.addEventListener("click",()=>{
    demo2.style.display="block"
    demo2.innerHTML=`
    <h1>CAPGEMINI APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b13.addEventListener("click",()=>{
    ...
    demo1.innerHTML=`
    <h1>AMAZON  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b14.addEventListener("click",()=>{
    demo1.style.display="block"
    demo1.innerHTML=`<h1>GOOGLE  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b15.addEventListener("click",()=>{
    demo1.style.display="block"
    demo1.innerHTML=`<h1>MICROSOFT  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b16.addEventListener("click",()=>{
    demo1.style.display="block"
    demo1.innerHTML=`<h1>ADOBE  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b17.addEventListener("click",()=>{
    demo1.style.display="block"
    demo1.innerHTML=`<h1>GOLDMAN SACHS  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b18.addEventListener("click",()=>{
    demo1.style.display="block"
    demo1.innerHTML=`<h1>CISCO  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b19.addEventListener("click",()=>{
    demo1.style.display="block"
    demo1.innerHTML=`<h1>ORACLE  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b20.addEventListener("click",()=>{
    demo1.style.display="block"
    demo1.innerHTML=`<h1>ZOHO  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b21.addEventListener("click",()=>{
    demo1.style.display="block"
    demo1.innerHTML=`<h1>FACEBOOK  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b22.addEventListener("click",()=>{
    demo1.style.display="block"
    demo1.innerHTML=`<h1>ADP  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b23.addEventListener("click",()=>{
    demo1.style.display="block"
    demo1.innerHTML=`<h1>DELOITE  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
...
b24.addEventListener("click",()=>{
    demo1.style.display="block"
    demo1.innerHTML=`<h1>AMD  APTITUDE  <br> PATTERN</h1>
    <table>
    <tr>
        <th>SECTION</th>
        <th>QUESTIONS</th>
